  ...
  return (
    <Box sx={{marginTop: {lg: '200px', xs: '20px'}}} p='20px'>
      <Typography variant='h6' mb='33ppx'>
        Watch how to do <span style={{color: '#ff2625', textTransform:'capitalize'}}>{name}</span> on <a href='https://m.youtube.com/results?sp=mAEA&search_query=Workout+exercises' style={{color: 'blue'}}> Youtube</a>
      </Typography>
